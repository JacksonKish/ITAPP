...
render() {
    ...
    styles={
        ...
        Image_2:{height:"50%", width:"86%", borderWidth:1, resizeMode:"stretch", alignSelf:"center", },
        TouchableOpacity_3:{height:"7%", width:"35%", backgroundColor:"#99531A", position:"absolute", top:"72%", left:"13%", },
        Text_7:{color:"#000000", fontFamily:"Lato", fontSize:22, textAlign:"center", top:"25%", },
        TouchableOpacity_4:{height:"7%", width:"35%", backgroundColor:"#333333", position:"absolute", top:"72%", left:"57%", },
        Text_8:{color:"#FFFFFF", fontFamily:"Lato", fontSize:22, textAlign:"center", top:"25%", },
        TouchableOpacity_5:{height:"7%", width:"35%", backgroundColor:"#333333", position:"absolute", top:"85%", left:"57%", },
        Text_10:{color:"#FFFFFF", fontFamily:"Lato", fontSize:22, textAlign:"center", top:"25%", },
        TouchableOpacity_6:{height:"7%", width:"35%", backgroundColor:"#333333", position:"absolute", top:"85%", left:"13%", },
